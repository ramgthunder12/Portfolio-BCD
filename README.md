...
- 부산 해커톤 'DIVE' – 부산테크노파크 원장상(2등)
    - 프로젝트 목표 :  현지인의 추천 여행지와 일정을 공유하고, 동행 모집·채팅 기능을 통해 여행 만족도를 높이는 모바일 서비스 프로토타입 개발
- 2024 한국디지털콘텐츠학회 하계 종합학술대회 – 동상
    - 논문 명 : CNN 기반 무인 매장 이상행동 예측 모델 설계 및 실험
    - 프로젝트 목표 : DenseNet-264와 ResNet-200 모델 성능을 비교 후 우수한 모델을 활용하여, Flask 기반 웹에서 업로드된 CCTV 영상 속 절도 행위를 자동 탐지하고 행위자 이미지를 캡처하여 결과를 제공
